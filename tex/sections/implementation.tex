...
\begin{figure}[H]
	\centering
	\includegraphics[height=.11\textheight]{dlp-projector-diagram-dmd}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=.11\textheight]{camera-intrinsics-2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.86\textwidth]{opengl-mvp}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=.1\textheight]{gl-projection-matrix}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.5\textwidth]{similar-triangles}
