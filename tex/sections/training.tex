\section{Training operators to assemble a starter motor}\label{sec:results}
...
\begin{figure}[ht]
	\centering
	\includegraphics[height=.33\textheight]{hardware-front}
	\includegraphics[height=.33\textheight]{hardware-side}
